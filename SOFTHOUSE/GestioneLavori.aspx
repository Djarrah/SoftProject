<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="GestioneLavori.aspx.cs" Inherits="Default2" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $('#btnInserisci').click(function () {
                var url = '/PopUp/Inserisci/Lavori.aspx';
            ...
            $('#btnModifica').click(function () {
                var url = '/PopUp/Modifica/Lavori.aspx';
                var dialog = $('<iframe src="' + url + '" frameborder="0"></iframe>').appendTo('body');
